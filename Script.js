...
function endGame() {
    document.getElementById('ascii-art').innerText = `
        ...
        |------------|
    `;
    document.getElementById('game-text').innerText = `Congratulations, ${playerName}! You've completed the scavenger hunt and unlocked the secrets of the digital world! Make a peace sign with your hand to get credit from Mr. March-Steinman and a prize`;
